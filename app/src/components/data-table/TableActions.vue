...
import ItemSort from './filter/ItemSort.vue';
    ...
    <div
      ...
      <div v-if="showFilters"
        ...
        <button id="filterDropdownButton" @click="toggleDropdown"
          class="min-w-[125px] md:w-auto flex items-center py-2 px-4 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded border border-gray-300 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 whitespace-nowrap"
          type="button">
          <div class="flex items-center space-x-2">
            <span>Filtrar/Ordenar por</span>
        ...
        <div v-if="isDropdownVisible"
          ...
          <h6 v-if="filters === undefined && sorters === undefined" class="text-base font-medium text-gray-900">
            Em breve
          </h6>
          ...
          <template v-if="sorters !== undefined">
            <ItemSort :sort="sorters" label="Ordenar Por" @updateSort="emitSort" />
          </template>
